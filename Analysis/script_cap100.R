...
data1 = read.csv('../term1/cap/term1_cap100_scaled.csv')%>%select(-c('Speaker','X'))
data2 = read.csv('../term2/cap/term2_cap100_scaled.csv')%>%select(-c('Speaker','X'))
data3 = read.csv('../term3/cap/term3_cap100_scaled.csv')%>%select(-c('Speaker','X'))
data4 = read.csv('../term4/cap/term4_cap100_scaled.csv')%>%select(-c('Speaker','X'))
data5 = read.csv('../term5/cap/term5_cap100_scaled.csv')%>%select(-c('Speaker','X'))
