...
model.p.log1 <- train(
  ...
  method = "regLogistic",
  MaxNWts = 10000000,
  tuneGrid = expand.grid(cost=0, loss='L1', epsilon = 0),
...
readr::write_csv(res.p.log.top500.scaled,'../Results/result_terms_regLogistic_cap50_scaled.csv')


# saveRDS(model.p.log1, "model_p.log1_cap50.rds")
# saveRDS(model.p.log2, "model_p.log2_cap50.rds")
# saveRDS(model.p.log3, "model_p.log3_cap50.rds")
# saveRDS(model.p.log4, "model_p.log4_cap50.rds")
# saveRDS(model.p.log5, "model_p.log5_cap50.rds")
