...
acc_list <- list(
                  term1    = mean(caret[1]$resample$Accuracy),
                  term2    = mean(caret[2]$resample$Accuracy),
                  term3    = mean(caret[3]$resample$Accuracy),
                  term4    = mean(caret[4]$resample$Accuracy),
                  term5    = mean(caret[5]$resample$Accuracy)
                  )
