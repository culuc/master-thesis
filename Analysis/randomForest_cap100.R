...
res.rf.cap100.scaled <- tibble(mtry,splitrule,term1.rf,term2.rf,term3.rf,term4.rf,term5.rf)
readr::write_csv(res.rf.cap100.scaled,'../Results/result_terms_rf_cap100_scaled.csv')


# saveRDS(model.rf1, "model_rf1_cap100.rds")
# saveRDS(model.rf2, "model_rf2_cap100.rds")
# saveRDS(model.rf3, "model_rf3_cap100.rds")
# saveRDS(model.rf4, "model_rf4_cap100.rds")
# saveRDS(model.rf5, "model_rf5_cap100.rds")
