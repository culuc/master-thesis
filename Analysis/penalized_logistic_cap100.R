...
res.p.log.top500.scaled <- data.frame(rbind(term1.p.log,term2.p.log,term3.p.log,term4.p.log,term5.p.log))
...
# saveRDS(model.p.log4, "model_p.log4_cap100.rds")
# saveRDS(model.p.log5, "model_p.log5_cap100.rds")
