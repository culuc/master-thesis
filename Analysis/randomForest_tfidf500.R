...
multinom(Speaker.Party ~ .,MaxNWts = 10000000,data=data1)
model.rf1 <- train(
  Speaker.Party ~ .,
  data1,
  # preProcess = "range",
...
res.rf.top500.scaled <- tibble(mtry,splitrule,term1.rf,term2.rf,term3.rf,term4.rf,term5.rf)
readr::write_csv(res.rf.top500.scaled,'../Results/result_terms_rf_top500_scaled.csv')


# saveRDS(model.rf1, "model_rf1_top500.rds")
# saveRDS(model.rf2, "model_rf2_top500.rds")
# saveRDS(model.rf3, "model_rf3_top500.rds")
# saveRDS(model.rf4, "model_rf4_top500.rds")
# saveRDS(model.rf5, "model_rf5_top500.rds")
