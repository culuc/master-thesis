...
readr::write_csv(res.multinom.top500.scaled,'../Results/result_terms_multinom_top500_scaled.csv')


# saveRDS(model.multi1, "model_multi1_top500.rds")
# saveRDS(model.multi2, "model_multi2_top500.rds")
# saveRDS(model.multi3, "model_multi3_top500.rds")
# saveRDS(model.multi4, "model_multi4_top500.rds")
# saveRDS(model.multi5, "model_multi5_top500.rds")
